...
{
    // to do: need to make IOffense and IDefense
    public interface IValue<T> where T : Enum
    {
        public double GetValue(T type);
    }
    ...
    public interface IProficiency<T> where T : Enum
    {
    ...
    public static class Calculations
    {
        ...
        {
            return damage.Value * offense.Proficiency(damage.Type) / damage.Factor(defense, offense);
        }
        ...
        /// <summary>
        /// tries to get a proficiency value from a source with a matching type
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="offense"></param>
        /// <param name="other"></param>
        /// <returns></returns>
        public static double Proficiency<T>(this IOffense<T> offense, object source) where T : Enum
        {
            if (source is not IProficiency<T> tool) return 1;
            return 1 + offense.GetOffense(tool.Type) * tool.Proficiency;
        }
    ...
    public class Spiceball : IDamage<Damage.Type>
    {
